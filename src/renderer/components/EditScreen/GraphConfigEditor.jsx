...
function GraphConfigEditor({ question, onQuestionChange }) {
  ...
  const handleConfigChange = (field, value) => {
      ...
      if (field === 'rollingWindowSize') {
          processedValue = value === '' ? 7 : Math.max(1, parseInt(value, 10) || 1); // Default to 7, ensure >= 1 integer
          ...
          {(type === 'yes_no' || type === 'multiple_choice') && (
            <label>
              ...
              <input
                ...
                min="1"
                step="1"
                value={graphConfig.rollingWindowSize === undefined ? 7 : graphConfig.rollingWindowSize} // Default to 7 if undefined
